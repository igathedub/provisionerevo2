...
import skyy.blue.Provisionerevo2App;
import skyy.blue.config.Constants;
import skyy.blue.domain.Authority;
import skyy.blue.domain.User;
import skyy.blue.repository.AuthorityRepository;
import skyy.blue.repository.UserRepository;
import skyy.blue.security.AuthoritiesConstants;
import skyy.blue.service.MailService;
import skyy.blue.service.UserService;
import skyy.blue.service.dto.PasswordChangeDTO;
import skyy.blue.service.dto.UserDTO;
import skyy.blue.web.rest.errors.ExceptionTranslator;
import skyy.blue.web.rest.vm.KeyAndPasswordVM;
import skyy.blue.web.rest.vm.ManagedUserVM;
 ...
 */
@SpringBootTest(classes = Provisionerevo2App.class)
